...
options=("docker" "portainer" "update" "yunohost" "Quit")
select opt in "${options[@]}"
do
    case $opt in
        "docker")
            echo "you chose choice install docker"
            #!/bin/bash
...
sudo apt-get install docker-ce docker-ce-cli containerd.io
            ;;
        "portainer")
            echo "you chose install portainer"
            #!/bin/bash
...
"
            ...
            ;;
        "yunohost")
            echo "you chose install yunohost"
